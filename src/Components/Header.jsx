...
export default function Header() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`https://${deployedIp}:4000/user/details`,config);
  ...
  const logoutHandler = async ()=> {
    ...
    try {
      const response = await axios.get(`https://${deployedIp}:4000/registration/logout`,config);
  ...
  const historyHandler= async ()=> {
    ...
    try {
      const response = await axios.get(`https://${deployedIp}:4000/campaign/history`,config);
