...
const CampaignCard = ({campaign}) => {
    ...
    const upvoteHandler = async(e)=>{
        ...
        const response = await axios.put(`${deployedIp}/campaign/edit/upvote`, { campaignId: campaign._id },config);
    ...
    const downvoteHandler = async(e)=>{
        ...
        console.log("CLiked liked",campaign._id);
        const response = await axios.put(`${deployedIp}/campaign/edit/downvote`, { campaignId: campaign._id },config);
        alert(response.data.message);
        console.log("error",response.data);
        } catch (error) {
            alert(error.response.data.message);
    ...
    const followHandler = async (e)=>{
        ...
        try {
            ...
            const response = await axios.put(`${deployedIp}/campaign/edit/follow`, { 
